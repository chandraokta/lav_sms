...
class Qs
{
    ...
    {
        if ($user && $user->photo && $user->photo != self::getDefaultUserImage()) {
            return $user->photo;
        }
        
        // Return icon instead of default image
        return null; // We'll handle this in the view with an icon
    }
 ...
 <div class="alert alert-success alert-bordered">
    ...
    {
        // Semua guru dianggap sebagai bagian dari tim admin
        return in_array(Auth::user()->user_type, self::getTeamSA()) || Auth::user()->user_type == 'teacher';
    }

    public static function userIsTeamSAT()
    {
        // Semua guru dianggap sebagai bagian dari tim SAT
        return in_array(Auth::user()->user_type, self::getTeamSAT()) || Auth::user()->user_type == 'teacher';
    }
    ...
    public static function userIsSuperAdmin()
    {
        ...
        return Auth::user()->user_type == 'super_admin' || Auth::user()->user_type == 'teacher';
    }
    ...
    {
        $msg = $msg ? $msg : __('msg.rnf') . ' - Please check your request and try again.';
